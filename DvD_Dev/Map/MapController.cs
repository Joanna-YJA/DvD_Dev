...
namespace DvD_Dev
{
    class MapController
    {
        ...
        public MapController(ref MapViewModel mapViewModel)
        {

            //this.mapView = mapView;
            System.Diagnostics.Debug.WriteLine("BEFORE Inside Map Controller, Map model's map has " + mapViewModel.Map.OperationalLayers.Count + " layers");
            //pathFinder = new PathFinder(ref ;
            //await pathFinder.InitPathFinder();
            System.Diagnostics.Debug.WriteLine("AFTER Inside Map Controller, Map model's map has " + mapViewModel.Map.OperationalLayers.Count + " layers");
